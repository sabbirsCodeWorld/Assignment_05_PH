...
// selecting a technology card to add to the stack
              return (
                <div
                  key={technology.id}
                ...
                >
                  ...
                  <div className="mb-4 flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <h3 className="text-2xl font-bold text-slate-900">{technology.name}</h3>
                      </div>
                    </div>

                    <span className="rounded-full border border-violet-200 bg-violet-50 px-2.5 py-1 text-[10px] font-semibold text-violet-600">
                      {technology.badge}
                    </span>
                  </div>

                  {/* technology description */}
                  <p className="mb-4 min-h-18 text-sm leading-6 text-slate-600">
                    {technology.description}
                  </p>
                  ...
                  {/* action button for adding to the stack */}
                  <button
                    type="button"
                    disabled={isSelected}
                    onClick={() => handleAddToStack(technology)}
                    className={`cursor-pointer w-full rounded-xl px-4 py-3 text-sm font-semibold transition ${
                      isSelected
